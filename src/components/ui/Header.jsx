...
const Header = () => {
  ...
  // Track scroll position to adjust header background
  useEffect(() => {
    const handleScroll = () => {
  ...
  const secondaryItems = [
    {
      name: "Trust Center",
      path: "/trust-transparency-center",
      icon: "Shield",
    },
  ];
        ...
        <div className="flex items-center justify-between h-16 px-6">
          ...
          <Link to="/homepage" className="flex items-center space-x-2 group">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold text-foreground font-accent">
                Beauty Glow
              </span>
              <span className="text-xs text-muted-foreground -mt-1">
                Authentic Beauty Journey
              </span>
            </div>
          </Link>
