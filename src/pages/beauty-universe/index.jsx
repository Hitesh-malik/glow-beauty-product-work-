  ...
  const mockProducts = [
    {
      ...
      isBestseller: true,
      glowMatches: [
        { name: "Sarah M.", avatar: "https://randomuser.me/api/portraits/women/1.jpg" },
        { name: "Emma K.", avatar: "https://randomuser.me/api/portraits/women/2.jpg" },
        { name: "Lisa R.", avatar: "https://randomuser.me/api/portraits/women/3.jpg" },
        { name: "Maya P.", avatar: "https://randomuser.me/api/portraits/women/4.jpg" }
      ],
      variants: [
        { id: 1, name: "15% Vitamin C", price: 45.00 },
        { id: 2, name: "20% Vitamin C", price: 55.00 }
      ]
    },
    {
      id: 2,
      ...
      isBestseller: false,
      glowMatches: [
        { name: "Jennifer L.", avatar: "https://randomuser.me/api/portraits/women/5.jpg" },
        { name: "Amanda S.", avatar: "https://randomuser.me/api/portraits/women/6.jpg" },
        { name: "Rachel T.", avatar: "https://randomuser.me/api/portraits/women/7.jpg" }
      ]
    },
    {
      id: 3,
      ...
      isBestseller: true,
      glowMatches: [
        { name: "Olivia M.", avatar: "https://randomuser.me/api/portraits/women/8.jpg" },
        { name: "Sophia K.", avatar: "https://randomuser.me/api/portraits/women/9.jpg" }
      ]
    },
    {
      id: 4,
      ...
      isBestseller: false,
      glowMatches: [
        { name: "Zoe R.", avatar: "https://randomuser.me/api/portraits/women/10.jpg" },
        { name: "Chloe B.", avatar: "https://randomuser.me/api/portraits/women/11.jpg" },
        { name: "Grace W.", avatar: "https://randomuser.me/api/portraits/women/12.jpg" }
      ],
      variants: [
        { id: 1, name: "Fair", price: 52.00 },
        { id: 2, name: "Light", price: 52.00 },
        { id: 3, name: "Medium", price: 52.00 },
        { id: 4, name: "Deep", price: 52.00 }
      ]
    },
    {
      id: 5,
      ...
      isBestseller: false,
      glowMatches: [
        { name: "Mia C.", avatar: "https://randomuser.me/api/portraits/women/13.jpg" },
        { name: "Ava D.", avatar: "https://randomuser.me/api/portraits/women/14.jpg" }
      ]
    },
    {
      id: 6,
      ...
      isBestseller: true,
      glowMatches: [
        { name: "Isabella F.", avatar: "https://randomuser.me/api/portraits/women/15.jpg" },
        { name: "Charlotte G.", avatar: "https://randomuser.me/api/portraits/women/16.jpg" },
        { name: "Amelia H.", avatar: "https://randomuser.me/api/portraits/women/17.jpg" }
      ]
    },
    {
      id: 7,
      ...
      isBestseller: false,
      glowMatches: [
        { name: "Harper I.", avatar: "https://randomuser.me/api/portraits/women/18.jpg" },
        { name: "Evelyn J.", avatar: "https://randomuser.me/api/portraits/women/19.jpg" }
      ],
      variants: [
        { id: 1, name: "Nude Collection", price: 65.00 },
        { id: 2, name: "Bold Collection", price: 65.00 },
        { id: 3, name: "Berry Collection", price: 65.00 }
      ]
    },
    {
      id: 8,
      ...
      isBestseller: false,
      glowMatches: [
        { name: "Victoria K.", avatar: "https://randomuser.me/api/portraits/women/20.jpg" },
        { name: "Natalie L.", avatar: "https://randomuser.me/api/portraits/women/21.jpg" }
      ]
    }
  ];
      ...
      <main className="pt-16">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2">Beauty Universe</h1>
            <p className="text-muted-foreground max-w-2xl">
              Discover your perfect beauty match through our innovative categorization system. 
              Find products by concern, ingredient, lifestyle, or glow goal.
            </p>
          </div>
