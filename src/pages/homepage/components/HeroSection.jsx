        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl lg:text-2xl text-white/90 max-w-2xl leading-relaxed">
                Discover your unique beauty journey with personalized
                recommendations, expert guidance, and a community that
                celebrates every glow.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-8 justify-center lg:justify-start pt-8">
              <div className="text-center">
                ...
                <div className="text-white/80 text-sm">
                  Glow Journeys Started
                </div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white">50K+</div>
                <div className="text-white/80 text-sm">
                  Beauty Stories Shared
                </div>
              </div>
              <div className="text-center">
          ...
          <div className="relative">
            <div className="relative z-10">
              <Image
                src="https://images.unsplash.com/photo-1556228720-195a672e8a03?w=600&h=800&fit=crop&crop=face&auto=format&q=80"
            ...
            {/* Beauty Product Elements */}
            <div className="absolute top-1/4 -left-8 bg-gradient-to-r from-pink-400/80 to-purple-400/80 backdrop-blur-sm rounded-full p-3 shadow-lg">
              <span className="text-white text-lg">💄</span>
            </div>
            <div className="absolute bottom-1/4 -right-6 bg-gradient-to-r from-rose-400/80 to-pink-400/80 backdrop-blur-sm rounded-full p-3 shadow-lg">
              <span className="text-white text-lg">🧴</span>
            </div>
            <div className="absolute top-1/2 right-1/4 bg-gradient-to-r from-purple-400/80 to-blue-400/80 backdrop-blur-sm rounded-full p-2 shadow-lg">
              <span className="text-white text-sm">💅</span>
            </div>
          </div>
        </div>
